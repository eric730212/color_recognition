...
img_original = cv2.imread('pic/color3.jpg')
...
cv2.createTrackbar('LowerbH', winName, 1, 255, nothing)
cv2.createTrackbar('LowerbS', winName, 242, 255, nothing)
cv2.createTrackbar('LowerbV', winName, 88, 255, nothing)
cv2.createTrackbar('UpperbH', winName, 155, 255, nothing)
...
while (1):
    ...
    for cnt in contours:
        ...
        cv2.putText(img_original, "L", (x, y - 5), font, 0.7, (0, 255, 0), 2)
